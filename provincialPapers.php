...
<head>
    ...
    <title>Provincial Papers | WisdomLanka.lk</title>
                    ...
                    <div class="col-12 bg-primary">
                        <div class="row">
                            ...
                            <div class="col-6 col-lg-3 my-4 mx-5">
                                <span class="fs-1 fw-bolder text-white" style="font-family: 'NotoSerif';">Provincial Papers</span>
                            </div>

                            <div class="col-6 col-lg-2 offset-lg-6 pt-2 my-4 d-grid">
                                <div class="ui vertical animated button ui yellow button" tabindex="0" onclick="window.location = 'school_Papers.php';">
                                    <div class="hidden content text-black">Back to School Papers</div>
                                    <div class="visible content school-icon"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        ?>
                            ...
                            <div class="col-12 col-lg-2 mt-3 mb-5 pt-2 pb-2 ps-4 pe-4 border border-1 border-info">
                                <div class="row">
                                    ...
                                    <select class="form-select" style="font-family: 'Ubuntu';" id="year-select">
                                        ...
                                        $provincial_papers_rs = Database::search("SELECT * FROM `resource` WHERE `category_category_id` = '8' AND `resource_mode_resource_mode_id` = '1'");

                                        $provincial_data = $provincial_papers_rs->fetch_assoc();
                                    ...
                                    <div class="col-12 text-center mt-3 mb-3">
                                        <div class="row g-2">
                                            <div class="col-12 col-lg-6 d-grid">
                                                <button class="ui inverted green button fw-bold" onclick="sort(0,'<?php echo $provincial_data['category_category_id']; ?>');">Sort</button>
                                            </div>
                            ...
                            <div class="col-12 col-lg-8 offset-lg-1 mt-4 mb-5 ps-5" id="sort">
                                <div class="row">
                                    ...
                                    $provincial_papers_num = $provincial_papers_rs->num_rows;

                                    for ($x = 0; $x < $provincial_papers_num; $x++) {
                                        $provincial_papers_data = $provincial_papers_rs->fetch_assoc();
                                    ...
                                    ?>
                                        ...
                                        <!-- <div class="col-12 border border-1 border-dark-subtle rounded rounded-4 p-4 mb-3">
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-lg-7 p-2 ps-5 mt-2 mb-3" style="cursor: pointer;">
                                                    <span class="fw-bold fs-5"><?php echo $provincial_papers_data["title"]; ?></span>
                                                </div>

                                                <div class="col-12 col-lg-4 p-2">
                                                    <button class="ui green button shadow rounded rounded-5" onclick="filePreview('<?php echo $provincial_papers_data['resource_id']; ?>');">Preview and Download File</button>
                                                </div>
                                        ...
                                        <!-- <div class="card mb-3 rounded rounded-4">
                                            ...
                                            <div class="card-body">
                                                <h4 class="card-title fw-bold text-primary" style="font-family: 'signika';"><?php echo $provincial_papers_data["title"]; ?></h4>
                                        ...
                                        <div class="card mb-3" style="max-width: 800px;">
                                            <div class="row g-0">
                                                ...
                                                <div class="col-md-8 mt-3">
                                                    <div class="card-body">
                                                        <h4 class="card-title fw-bold text-primary mt-3" style="font-family: 'signika';"><?php echo $provincial_papers_data["title"]; ?></h4>
                                                        <div class="col-12 col-lg-10 p-2 mt-4">
                                                            <button class="ui green button shadow rounded rounded-5" onclick="filePreview('<?php echo $provincial_papers_data['resource_id']; ?>');">Preview and Download File</button>
                                                        </div>
                                                    </div>
                                                </div>
